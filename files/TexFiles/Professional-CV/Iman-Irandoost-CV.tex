...
%	\layout
	...
	\section{Research Interests}
		...
		\interestItem{Algorithms \& Data Structures}{Intelligent Transportation Systems, Constraint Satisfaction Problems}\vspace{1 mm}\\
		\interestItem{Mathematics}{Combinatorics, Number Theory, Linear Algebra, Game Theory}
	%Section: Education
	\section{Education}
		\begin{tabular}{rl}	
			\textbf{2013 - 2016} & \textbf{\textit{Isfahan University of Technology}}\\
					       ...
					       & {\small \textbf{GPA:}\emgr{16.25/20.00}} %TODO: Dept Avg
		\end{tabular}
	\section{Relevant Academic Courses}
		\begin{tabular}{llll}
			...
			\courseItem{Combinatorics}{17.8/20.0}&\courseItem{Web Programming}{19.1/20.0}
		\end{tabular}
